...
public:
    ...
    void setHalfpipeWall(bool isSet);
    ...
    [[nodiscard]] bool isHalfpipeWall() const;
...
private:
    ...
    bool m_bHalfpipeWall; ///< e.g. DK Summit ending, and Maple Treeway side walls.
    bool m_bTrickable;
    /// @}
