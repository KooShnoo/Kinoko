...
bool KartState::isHalfpipeWall() const {
    return m_bHalfpipeWall;
}
...
void KartState::setAirStart(bool isSet) {
    m_bAirStart = isSet;
}
...
void KartState::setHalfpipeWall(bool isSet) {
    m_bHalfpipeWall = isSet;
}
